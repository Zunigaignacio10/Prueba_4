...
from .views import form_eliminar, form_producto, index, galeria, somos, api, formulario,  validacion, form_producto, validacionContacto, ventaproductos, formularioContacto, modificar, ingresoweb, login, form_producto, form_eliminar, MostrarC, ModificarC, form_cliente, form_eliminar_cliente
...
urlpatterns = [
     ...
     path('AgregarC/', form_cliente, name="AgregarC"),
